                ...
                </View>
                {
                    this.state.searchtext.length > 0 ?
                        this.state.SearchList.map((data, i) => (
                           (this.state.Assignmentslist[data].status === 'request'&&this.state.Assignmentslist[data].userid!=CUid && date_diff_indays(this.state.Assignmentslist[data].duedate)>=0) && <TouchableWithoutFeedback key={i} onPress={() => this.toggleModal2(data,this.state.Assignmentslist[data].userid)}>
